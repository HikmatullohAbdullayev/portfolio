...
//           <div
//             key={project.name}
//             className="p-[10px] shadow-sm rounded-2xl  bg-slate-100 hover:shadow py-[10px] px-16px border "
//           >
...
//               <Link className="text-red-500 " to={project.website}>
//                 {' '}
//                 Web sayt
//               </Link>
//               <Link className="text-yellow-500" to={project.github}>
//                 Git hub
//               </Link>
//             </div>
//             <p
